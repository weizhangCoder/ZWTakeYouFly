...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HSSetTableViewController/HSSetTableViewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZTVendorManager/ZTVendorManager.framework"
fi
